...
__all__ = [
    ...
    "InlineQueryResultAnimation", "InlineQueryResultAudio", "InlineQueryResultVideo", "InlineQueryResultCachedDocument", "InlineQueryResultCachedPhoto", "ChosenInlineResult"
]
